    ...
    <main className='p-3 max-w-4xl mx-auto'>
      ...
      <form className='flex flex-col sm:flex-row gap-4' onSubmit={handleSubmit} >
        ...
        <div className='flex flex-col flex-1 gap-4' >
          ...
          <button className='p-3 bg-slate-700 text-white uppercase rounded-lg disabled:opacity-800 hover:opacity-95' disabled={loading || uploading}>{loading ? 'Loading....' : "Update Listing"}</button>
          {
