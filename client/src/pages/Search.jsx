            ...
            <div className='p-7 border-b-2 md:border-r-2 md:min-h-screen'>
                <form className='flex flex-col gap-8' onSubmit={submitHandler}>
                    <div className='flex items-center gap-2'>
                        ...
                        <input type='text' id='searchTerm' placeholder='Search...' className='p-3 w-full border rounded-lg ' value={sideBarData.searchTerm} onChange={handleChange}/>
                    </div>
                    ...
                    <button className='bg-slate-700 text-white p-3 rounded-lg uppercase font-semibold'>Search</button>
                </form>

            </div>

            <div className=''>
                <h1 className='font-bold text-2xl border-b p-3 mt-5 text-slate-700 hover:opacity-95'>Listing results: </h1>
            </div>
